...
def graph2smile(graph, atom_decoder):
...
class BasicMolecularMetrics(object):
    ...
    def my_compute_validity(self, generated):
        # only use this function to save the valid graphs and I do not want to change the function compute_validity...
        """ generated: list of couples (positions, atom_types)"""
        valid_graphs = []
        valid = []
        num_components = []
    ...
    def my_compute_novelty(self, valid_graphs, valid):
        # only use this function to save the novel and unnovel graphs and I do not want to change the function compute_novelty...
        novel = []
        novel_graphs = []
        unnovel_graphs = []
        ...
        for i, smiles in enumerate(valid):
            if smiles not in self.dataset_smiles_list:
                novel_graphs.append(valid_graphs[i])
            else:
                unnovel_graphs.append(valid_graphs[i])
        return novel_graphs, unnovel_graphs
