...
```bash
pip install -r evaluation/requirements_metrics.txt
```
...
```bash
cd evaluation
python evaluate_metrics.py --generated generated.smi --reference qm9_reference.smi
```

### Enhanced Usage (with Graph Data)
...
cp evaluation/qm9_reference.smi my_reference.smi
```
...
- [ ] Install dependencies: `pip install -r evaluation/requirements_metrics.txt`
